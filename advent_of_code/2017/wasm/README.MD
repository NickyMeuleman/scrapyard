Solutions to [Advent of Code 2017](https://adventofcode.com/2017) in the [Rust programming language](https://www.rust-lang.org/), usable through [WebAssemly](https://webassembly.org/).
