...
impl AoCData<'_> for Data {
    fn try_new(input: &str) -> AoCResult<Self> {
        let bits = input
            ...
            .collect::<AoCResult<Vec<Vec<bool>>>>()?;
...
mod test {
    ...
    fn part_1_1() {
        ...
        let data = Data::try_new(input).unwrap();
        assert_eq!(data.part_1().unwrap().to_string(), "16");
    }
    ...
    fn part_1_2() {
        ...
        let data = Data::try_new(input).unwrap();
        assert_eq!(data.part_1().unwrap().to_string(), "12");
    }
    ...
    fn part_1_3() {
        ...
        let data = Data::try_new(input).unwrap();
        assert_eq!(data.part_1().unwrap().to_string(), "23");
    }
    ...
    fn part_1_4() {
        ...
        let data = Data::try_new(input).unwrap();
        assert_eq!(data.part_1().unwrap().to_string(), "31");
    }
    ...
    fn sum() {
        ...
        let data = Data::try_new(input).unwrap();
        assert_eq!(data.part_2().unwrap().to_string(), "3");
    }
    ...
    fn product() {
        ...
        let data = Data::try_new(input).unwrap();
        assert_eq!(data.part_2().unwrap().to_string(), "54");
    }
    ...
    fn min() {
        ...
        let data = Data::try_new(input).unwrap();
        assert_eq!(data.part_2().unwrap().to_string(), "7");
    }
    ...
    fn max() {
        ...
        let data = Data::try_new(input).unwrap();
        assert_eq!(data.part_2().unwrap().to_string(), "9");
    }
    ...
    fn less_than() {
        ...
        let data = Data::try_new(input).unwrap();
        assert_eq!(data.part_2().unwrap().to_string(), "1");
    }
