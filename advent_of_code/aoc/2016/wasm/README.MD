Solutions to [Advent of Code 2016](https://adventofcode.com/2016) in the [Rust programming language](https://www.rust-lang.org/), usable through [WebAssemly](https://webassembly.org/).
