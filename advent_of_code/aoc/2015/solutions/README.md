Solutions to [Advent of Code 2015](https://adventofcode.com/2015) in the [Rust programming language](https://www.rust-lang.org/)
...
```rust
use aoc2015::{print_part, solve_part, Answer, Day, Part};
