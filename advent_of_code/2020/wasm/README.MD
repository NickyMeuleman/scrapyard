Solutions to [Advent of Code 2020](https://adventofcode.com/2020) in the [Rust programming language](https://www.rust-lang.org/), usable through [WebAssemly](https://webassembly.org/).
