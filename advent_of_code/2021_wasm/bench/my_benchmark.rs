...
fn run(c: &mut Criterion, num: u8) {
    ...
    match num {
        ...
        22 => run_day::<day_22::Data>(c, num, input),
        23 => run_day::<day_23::Data>(c, num, input),
        24 => run_day::<day_24::Data>(c, num, input),
        25 => run_day::<day_25::Data>(c, num, input),
