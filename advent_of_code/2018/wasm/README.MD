Solutions to [Advent of Code 2018](https://adventofcode.com/2018) in the [Rust programming language](https://www.rust-lang.org/), usable through [WebAssemly](https://webassembly.org/).
