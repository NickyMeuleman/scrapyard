...
impl AoCData for Data {
    ...
    fn part_1(&self) -> String {
        self.resolve_wire("a", &mut HashMap::new()).to_string()
    }
    ...
    fn part_2(&self) -> String {
        ...
        data.resolve_wire("a", &mut cache).to_string()
    }
        ...
        Self: Sized,
    {
        ...
        Solution {
            part1: a_result.to_string(),
            part2: data.resolve_wire("a", &mut cache).to_string(),
        }
    }
}