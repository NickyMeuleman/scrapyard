Solutions to [Advent of Code 2023](https://adventofcode.com/2023) in the [Rust programming language](https://www.rust-lang.org/), usable through [WebAssemly](https://webassembly.org/).
